...
const LocationSelector = ({ 
  ...
  const [selectedDivision, setSelectedDivision] = useState(initialLocation?.division || '');
  const [selectedDistrict, setSelectedDistrict] = useState(initialLocation?.district || '');
  const [selectedSubDistrict, setSelectedSubDistrict] = useState(initialLocation?.subDistrict || '');
  ...
  // Initialize districts when component mounts or division changes
  useEffect(() => {
    if (selectedDivision) {
  ...
  useEffect(() => {
    if (selectedDistrict) {
      setSubDistricts(locationData[selectedDivision]?.[selectedDistrict] || []);
    }
    ...
    <div className={`location-selector ${className}`}>
      ...
      <div className="location-inputs">
        <div className="input-group">
          <label htmlFor={`division-${title}`}>Division {required && '*'}</label>
          <select
            id={`division-${title}`}
        ...
        <div className="input-group">
          <label htmlFor={`district-${title}`}>District {required && '*'}</label>
          <select
            id={`district-${title}`}
        ...
        <div className="input-group">
          <label htmlFor={`subDistrict-${title}`}>Sub-district {required && '*'}</label>
          <select
            id={`subDistrict-${title}`}
